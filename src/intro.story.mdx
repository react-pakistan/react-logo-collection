...
<div>
  <left>
    <a href="https://taimoormk.github.io/react-icon-collection" target="_blank">
      <img src="https://res.cloudinary.com/dq6hflqwx/image/upload/v1567499955/GitHub/react-icons-collection.jpg" alt="React Pakistan - React Logo Collection" width="70%" />
    </a>
  </left>
...
A generic, SVG Logo library for React web apps & React Native apps, following modern approach by building your project's UI in isolation using state of the art Storybook along with React.
...
Import SVG Reactified Logos you want into your component
