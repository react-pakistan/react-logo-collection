# Contributing to react-commons-collection

Love react-commons-collection and want to help? Thank you so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/react-pakistan/react-commons-collection/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/react-logo-collection.git
    # Navigate to the newly cloned directory
    cd react-logo-collection
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/react-pakistan/react-logo-collection.git
    ```
...
owners to license your work under the terms of the [MIT License](https://github.com/react-pakistan/react-logo-collection/blob/master/LICENSE.md).
